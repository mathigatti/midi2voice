...
ap.add_argument("-lang", "--language", required=False, default="english", choices=['english', 'japanese', 'chinese'],
   help="Language of the voice (english/japanese/chinese)")
...
ap.add_argument("-i", "--voiceindex", required=False, default=0,
   help="Each language has different voices, for example japanese has 7 different female voices at the moment, chinese only one.")
